<template>
  <q-list>
    <q-item clickable to="/docs">
      ...
      <q-item-section>
        <q-item-label>QZoom docs</q-item-label>
    ...
    <q-item clickable to="/examples">
      ...
      <q-item-section>
        <q-item-label>QZoom examples</q-item-label>
        <q-item-label caption>Examples of how to do it</q-item-label>
      </q-item-section>
    </q-item>
    <q-separator />
    <q-item clickable tag="a" target="_blank" href="https://github.com/quasarframework/app-extension-qzoom">
      <q-item-section avatar>
        <q-icon name="extension" />
      </q-item-section>
      <q-item-section>
        <q-item-label>QZoom home</q-item-label>
        <q-item-label caption>qzoom</q-item-label>
      </q-item-section>
    </q-item>
